...
public class CashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goSpent = findViewById(R.id.control_spent_cash);
        goIncome = findViewById(R.id.control_income_cash);
        ...
        if (myIndex == 0) {//проверка были ли вообще введены доходы
            Toast toast = Toast.makeText(getApplicationContext(),
                    "Список Ваших доходов пуст! Добавьте доходы!", Toast.LENGTH_LONG);
        ...
        goSpent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CashActivity.this, ThirdActivity.class);
                startActivity(intent);
            }
        });
        ...
        goIncome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CashActivity.this, FoursActivity.class);
                startActivity(intent);
            }
        });
    }
